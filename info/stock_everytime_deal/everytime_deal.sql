CREATE TABLE everytime_deal
    (
        ...
        ratio FLOAT comment '涨跌幅',
        varies FLOAT  comment '价格变动',
        ...
        data_from VARCHAR(100) NOT NULL comment '数据来源：上海交易所（sse），深圳交易所(szse)，巨潮资讯(cninfo)，同花顺(tonghuashun),网易财经(163.com),新浪财经(sina)',
        PRIMARY KEY (id),
