...
requestHeaders={
    ...
    'Cookie': 'JSESSIONID=abc74-j8S2jkQamORmURv; ys-userName=s%3A36072102001',
    'Pragma': 'no-cache',
...
page_size=500
# 写入文件名称
writepath=r"/Users/leo/trscases/gitproject/StockSpider/medicalInfomation_nt.xlsx" 
#写表头
wb=Workbook()  
...
for i in range(0,94):
    ...
    content=getContent(i*page_size,page_size)
    for o in content:
        startColum=1
