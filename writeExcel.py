...
def writeexcel07(path):  
    ...
    wb=Workbook()  
    #sheet=wb.add_sheet("xlwt3数据测试表")  
    sheet=wb.create_sheet("xlwt3数据测试表",0)  
...
#excelpath=r"/Users/leo/trscases/gitproject/StockSpider/名称.xlsx"  
writepath=r"/Users/leo/trscases/gitproject/StockSpider/书籍明细07.xlsx"  
#writeexcel03(writepath)  
writeexcel07(writepath)  
  
# read07path="/Users/leo/trscases/gitproject/StockSpider/名称.xlsx";  
  
  
# read03path=r"/Users/leo/trscases/gitproject/StockSpider/同义词词库.xls";  
